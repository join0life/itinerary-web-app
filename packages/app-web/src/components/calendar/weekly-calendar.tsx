...
import { getThisWeekRange, isSameDay } from "@itinerary/shared";
 ...
 */
function splitEventByDay(event: CalendarEvent): CalendarEvent[] {
 ...
 * @returns
 */
function getGroupTop(group: CalendarEvent[]) {
 ...
 */
function prepareRenderEvents(group: CalendarEvent[]) {
